...
if(isset($_POST['formconnexion'])) {
   ...
   if(!empty($mailconnect) AND !empty($mdpconnect) AND ($_POST["g-recaptcha-response"])) {
      ...
      $requser = $bdd->prepare("SELECT * FROM proprietaire WHERE mail = ? AND motdepasse = ?");
...
<html>
 ...
 <a href="rendez_vous.php"style=" color:white;font-family:arial;"value="Connexion">Vous n'êtes pas encore inscris</a></p>
         </form>
