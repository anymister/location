...
<html>
  ...
  <?php
		...
		?>
         ...
         <article style="color: white;background-color: rgba(0,0,0,0.5);margin-right:34%;margin-left:32%;%;margin-top :-6%; border-radius:10px 10px;" id="volet">
            ...
            <form method="POST" style="color:white; padding-top :5%;padding-bottom :10%; padding-left:15%;action="" enctype="multipart/form-data">
               ...
               <input type="submit" style="background-color: rgba(199,21,133, 0.8);width: 50%; height: 35px;border-radius:10px 10px;border:transparent;color:white;font-family:arial;font-weight:bold;margin-left:16%;margin-top:10%;" value="Mettre à jour mon profil " />
            </form>
